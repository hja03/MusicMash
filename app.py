...
def result():
	...
	playlist = user1.create_playlist(f"{user1.name} and {user2.name} Fusion", "Generated by MusicMash")
	playlist2 = user2.create_playlist(f"{user1.name} and {user2.name} Fusion", "Generated by MusicMash")
